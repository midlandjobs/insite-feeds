...
(function(addon) {
    ...
    if (typeof define == "function" && define.amd) {
        define("mjkit-parallax", ["mjkit"], function(){
    ...
    UI.component('parallax', {
        ...
        boot: function() {
            ...
            UI.$doc.on("scrolling.midlandjobs.document", checkParallaxes);
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-midlandjobs-parallax]', context).each(function() {

                    var parallax = UI.$(this);

                    if (!parallax.data("parallax")) {
                        UI.parallax(parallax, UI.Utils.options(parallax.attr("data-midlandjobs-parallax")));
                    }
                });
            });
        },
