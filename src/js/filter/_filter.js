// requires
const Paginator = require('./_paginator.js');
const templateBuilder = require('./_template.js');
const each = require('./_util.js');
...
var FJS = function(records, container, options) {
  ...
  // custom
  // option for defining a static template for each job, which can be overriden on the page
  if(this.opts.template_html) this.setTemplateHtml(this.opts.template_html)
...
F.initPagination = function(){
  ...
  if(!opts.perPage){
    opts.perPage = {};
    this.opts.pagination.perPage.isDisabled = true; // custom code
  }
...
// custom function
// like setTemplate, but for direct html
F.setTemplateHtml = function(template, rebuild) {
  if(template){
    this.templateFn = templateBuilder(template);
    if(rebuild === true) {
      this.$container.empty();
...
module.exports = FJS; // custom exports